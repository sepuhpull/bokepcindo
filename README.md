...
A live demo of the project is available at [https://bokepcindo.pages.dev](https://bokepcindo.pages.dev/).
...
1. Fork the [repository](https://github.com/sepuhpull/bokepcindo/fork) on GitHub.
